            ...
            $.ajax({
                ...
                success : function (result) {
                    if(result.ret) {
                        ...
                        var rendered = Mustache.render(aclModuleListTemplate, {
                            ...
                            "showDownAngle": function () {
                                return function (text, render) {
                                    return (this.aclModuleList && this.aclModuleList.length > 0) ? "" : "hidden";//存在子模块
                                }
                            },
                        ...
                        recursiveRenderAclModule(result.data);//递归渲染层级结构
                        bindAclModuleClick();
                    } else {
            ...
            $(".aclModule-edit").click(function(e) {
                ...
                $("#dialog-aclModule-form").dialog({
                    ...
                    open: function(event, ui) {
                        ...
                        var targetAclModule = aclModuleMap[aclModuleId];//从map中取出
                        if (targetAclModule) {
